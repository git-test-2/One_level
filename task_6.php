    ...
    <body class="mod-bg-1 mod-nav-link ">
        <main id="js-page-content" role="main" class="page-content">
            ...
            <div class="row js-list-filter" id="js-contacts">
                ...
                <!--
                     Сформировать массив и вывести при помощи цикла foreach
                -->
                ...
                <?php
                    $users = [
                            ...
                            'tel' => '+1 317-456-2564',
                            'email_link' => 'mailto:oliver.kopyov@smartadminwebapp.com',
                ...
                <?php foreach ($users as $user): ?>
                    <div class="col-xl-4">
                        <div id="<?= $user['id']; ?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?= $user['tags']; ?>">
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                <div class="d-flex flex-row align-items-center">
                                <span class="status <?= $user['status']; ?>" mr-3">
                                    ...
                                    <div class="info-card-text flex-1">
                                        ...
                                        <!-- удалили или закомментировали -->
                                        <!-- <div class="dropdown-menu"> -->
<!--                                            <a class="dropdown-item" href="#">Send Email</a>-->
<!--                                            <a class="dropdown-item" href="#">Create Appointment</a>-->
<!--                                            <a class="dropdown-item" href="#">Block User</a>-->
<!--                                        </div>-->
                                        <span class="text-truncate text-truncate-xl"><?= $user['address']; ?></span>
                                    </div>
...
<!--                                    </button>-->
                            ...
                            <div class="card-body p-0 collapse show">
                                <div class="p-3">
                                    ...
                                    <a href="<?= $user['email_link']; ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
